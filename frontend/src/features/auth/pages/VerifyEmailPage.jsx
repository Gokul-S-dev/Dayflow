        ...
        <Card className="text-center">
          {status === 'VERIFYING' && (
            <CardContent className="py-12 space-y-4">
              ...
              <p className="text-sm font-semibold text-slate-700">Verifying your token with backend...</p>
            </CardContent>
          )}
          ...
          {status === 'SUCCESS' && (
            <>
              <CardHeader>
                <div className="mx-auto h-12 w-12 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mb-2">
                  <CheckCircle2 className="h-6 w-6" />
                </div>
                <CardTitle className="text-base text-emerald-800">Email Verified!</CardTitle>
          ...
          {status === 'ERROR' && (
            <>
              <CardHeader>
                <div className="mx-auto h-12 w-12 rounded-full bg-red-50 text-red-600 flex items-center justify-center mb-2">
                  <AlertCircle className="h-6 w-6" />
                </div>
                <CardTitle className="text-base text-red-800">Verification Failed</CardTitle>
                <CardDescription className="text-xs max-w-xs mx-auto text-red-600 font-medium">
                  {message}
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          {status === 'PENDING' && (
            <>
              <CardHeader>
                <div className="mx-auto h-12 w-12 rounded-full bg-blue-50 text-blue-700 flex items-center justify-center mb-2">
